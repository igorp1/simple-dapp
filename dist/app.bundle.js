...
/***/ (function(module, exports, __webpack_require__) {
	...
	var set_btn = document.getElementById('set-btn');
	var setBtnStream$ = _Rx2.default.Observable.fromEvent(set_btn, 'click');
	setBtnStream$.subscribe(function (e) {
	    /* event */
	    var value = Number(document.getElementById("set-input").value);
	    alert('Setting value to ' + value + '...');
	}, function (err) {/* error */}, function () {/* completed */});

	// observable for add action
	var add_btn = document.getElementById('add-btn');
	var addBtnStream$ = _Rx2.default.Observable.fromEvent(add_btn, 'click');
	addBtnStream$.subscribe(function (e) {
	    /* event */
	    var value = Number(document.getElementById("add-input").value);
	    alert('Adding ' + value + ' ...');
	}, function (err) {/* error */}, function () {/* completed */});

	// observable for increment action
	var inc_btn = document.getElementById('inc-btn');
	var incBtnStream$ = _Rx2.default.Observable.fromEvent(inc_btn, 'click');
	incBtnStream$.subscribe(function (e) {
	    /* event */alert('Incrementing value...');
	}, function (err) {/* error */}, function () {/* completed */});

	// observable for reset action
	var res_btn = document.getElementById('res-btn');
	var resBtnStream$ = _Rx2.default.Observable.fromEvent(res_btn, 'click');
	resBtnStream$.subscribe(function (e) {
	    /* event */alert('Resetting value...');
	}, function (err) {/* error */}, function () {/* completed */});
